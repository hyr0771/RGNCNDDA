...
from model import GraphConv,GNCN,RGNCN
from utils import *
...
path = "./dataset/Fdataset.mat" #Fdataset,Cdataset
...
class RGNCNq(nn.Module):
    def __init__(self):
        ...
        self.gnnqdr = RGNCN(drug.shape[1],256,args.hidden)
        self.gnnqd = RGNCN(disease.shape[0],256,args.hidden)
...
class GNCNp(nn.Module):
    def __init__(self):
        ...
        self.gnnpdr =GNCN(args.hidden,drug_disease.shape[1])
        self.gnnpds =GNCN(args.hidden,drug_disease.shape[0])
